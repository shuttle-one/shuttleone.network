...
//02/juky/2020 deploy v1  kovan 1,797,234 0xb5Ee208230feddC7652441896AbB24dF13047198
...
contract AccessControl is Permissions {

  event Paused();
  event Unpaused();

  mapping (address => bool) public CLevels;
  address public CEO;
  bool public paused = false;
  
  constructor() public{
      CLevels[msg.sender] = true;
      CEO = 0xafc5eDF046034fDb0C23d32d52564E23E49C8389;
      CLevels[0xafc5eDF046034fDb0C23d32d52564E23E49C8389] = true;
  }
  ...
  function setCLevel(address _newC) external {
      require(msg.sender == CEO);
      require(_newC != address(0));
      CLevels[msg.sender] = true;
  }

  function setCEO(address _CEO) external {
      require (msg.sender == CEO);
      require (_CEO != address(0));
      CEO = _CEO;
  }

  function removeCLevel(address _cLevel) external {
      require (msg.sender == CEO);
      require (_cLevel != address(0));
      CLevels[msg.sender] = false;
  }
...
contract RATTokenBeta16 is AccessControl,ERC165,IERC721{
    using EnumerableSet for EnumerableSet.UintSet;

    string public  name = "Risk Assesement Token Beta14";
...
//        ownershipTokenCount[_to]++;
    ...
    function getRatDetail(uint256 _tokenID) public view onlyCLevelOrPermits returns(uint256 _tokenType,uint256 _docID,address _contract){
    ...
    function setTools (address _addr) public onlyCLevelOrPermits{
       tools = S1Tools(_addr);
    }

    function changeName (string memory _name) public onlyCLevelOrPermits{
        name = _name;
    }
    
    function changeSymbol(string memory _symbol) public onlyCLevelOrPermits{
        symbol = _symbol;
    }
    ...
    function intTransfer(address _from, address _to, uint256 tokenId) external onlyCLevelOrPermits returns(bool){
    ...
    function setBaseURI(string memory _baseURI_) public onlyCLevel  {
        baseURI = _baseURI_;
    }
